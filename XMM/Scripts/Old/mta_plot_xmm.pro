...
xmm_archive    = xmm_dir + 'Data/xmm.archive'
;
...
;
openw,aunit,xmm_7d_archive,/get_lun
...
free_lun,aunit
spawn, "cat " + xmm_7d_archive +" >> " + xmm_archive
spawn, "sort -u -n -k 1,1 " + xmm_archive + " -o " + xmm_archive
;
;--- print web data
;
openw, hunit, web_dir + "xmm_2day.dat",/get_lun
...
write_gif,web_dir+'Plots/mta_xmm_plot.gif',tvrd()
