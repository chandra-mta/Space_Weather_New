...
;--- read CRM data
;
crm_dat = xmm_dir+'Data/crmreg_cxo.dat'
readcol, crm_dat,Csec,CR,CXgsm,CYgsm,CZgsm,Ccrmreg, $
...
write_gif,web_dir+'Plots/mta_plot_xmm_comp.gif',tvrd()
