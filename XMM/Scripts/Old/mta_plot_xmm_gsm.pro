...
;--- read XMM orbit
;
xmmfile = tle_dir + "Data/xmm.spctrk"
...
;--- read CXO orbit
;
cxofile = tle_dir + "Data/cxo.spctrk"
...
;
;openw,tunit,"./xdate_debug",/get_lun   ;debug
;openw,cunit,"./xcoords_debug",/get_lun ;debug
;
...
xmm_dat = xmm_dir+'Data/crmreg_xmm.dat'
readcol,xmm_dat,Csec,CR,CXgsm,CYgsm,CZgsm,Ccrmreg, $
...
;
cxo_dat = xmm_dir+'Data/crmreg_cxo.dat'
readcol,cxo_dat, Csec,CR, CXgsm, CYgsm, CZgsm, Ccrmreg, $
        format='L,F,F,F,F,I',skipline=5
...
write_gif,web_dir+'Plots/mta_xmm_plot_gsm.gif',tvrd()
print, "check here"
...
openw,cdat,xmm_dir+"Data/xcxo.gsm.dat",/get_lun
...
write_gif,web_dir+"Plots/time_x.gif",tvrd()
...
write_gif,web_dir+"Plots/time_y.gif",tvrd()
...
write_gif,web_dir+"Plots/time_z.gif",tvrd()
