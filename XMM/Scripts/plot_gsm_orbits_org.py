...
#
            ...
            plt.plot(x, y, color=cl, marker='.', markersize='0.0', ls = ':', lw=2.0)
            x = [x_gsm[k]]
            y = [y_gsm[k]]
            cl = xmm_color[k]
#
...
#
    ...
    plt.plot([x_gsm[cpos]],[y_gsm[cpos]], marker='*', markersize=6, color='aqua')

    cpos = find_index_of_time(current-86400, xtime)
    plt.plot([x_gsm[cpos]],[y_gsm[cpos]], marker='p', markersize=6, color='salmon')
#
#--- cxo orbit; each segment needs to be plot separately depending on the color
#
    plt.plot(cxo_x_gsm,cxo_y_gsm, color='white', marker='.', markersize='0.0', ls = '-', lw=1.0)
    x  = []
    y  = []
    cl = cxo_color[0]
...
#
    ...
    plt.plot([cxo_x_gsm[cpos]],[cxo_y_gsm[cpos]], marker='*', markersize=6, color='aqua')

    cpos = find_index_of_time(current-86400, ctime)
    plt.plot([cxo_x_gsm[cpos]],[cxo_y_gsm[cpos]], marker='p', markersize=6, color='salmon')
#
#--- the earth center
#
...
#--- van allen belt
#
    plt.plot(van_x, van_y,  color='orange', marker='.', markersize='0.0', lw=0.8)
    plt.plot(van_x, van_yn, color='orange', marker='.', markersize='0.0', lw=0.8)
#
#--- magnetosheath
#
    plt.plot(mag_x, mag_y,  color='lime', marker='.', markersize='0.0', lw=0.8)
    plt.plot(mag_x, mag_yn, color='lime', marker='.', markersize='0.0', lw=0.8)
#
#--- sun direction
#
    plt.arrow(12,0, 5, 0, color='yellow',head_width=0.8)
    plt.text(13, 0.1, "SUN", color='yellow', size=6)
#
#--- axis label
#
    ax.set_ylabel('Y_GSM(Re)')
