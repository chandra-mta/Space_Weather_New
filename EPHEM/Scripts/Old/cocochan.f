...
c         -o cocochan
c f77 cocochan.f geopack.f supple.f -o cocochan
...
c      real x,y,z,vx,vy,vz,pi,re,Xgm,Ygm,Zgm,Xge,Yge,Zge
     ...
     *'/data/mta4/Space_Weather/EPHEM/Data/PE.EPH.gsme')
      open(unit=3,name=
     *'/data/mta4/Space_Weather/EPHEM/Data/PE.EPH.gsme_in_Re')
...
c
c--- it seems that this function is not used  (Aug 08, 2018, TI)
c
