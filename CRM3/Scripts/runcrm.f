...
c     September 2002
c
c       Last update: Mar 24, 2020     TI
c
c       gfortran -std=legacy -ffixed-form -fd-lines-as-comments
c                -ffixed-line-length-none runcrm.f
c                /data/mta4/Space_Weather/CRMFLX/CRMFLX_V33/CRMFLX_V33.f
c                -o runcrm
...
c         read(1,*,iostat=ios)
   ...
   10 close (1)
      ...
      do i = 1,28
        xkp = (i-1)/3.0
        open(unit=2,file=
     $ '/data/mta4/Space_Weather/CRM3/Data/CRM3_p.dat'//fext(i))
        do j = 1,iv
