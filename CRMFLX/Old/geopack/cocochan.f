...
c      open(unit=1,file='/data/mta/Script/Ephem/PE.EPH.dat')
c      open(unit=2,file='/data/mta/Script/Ephem/PE.EPH.gsme')
      open(unit=1,file='/data/mta/Script/Ephem/Exc/dephem.dat')
      open(unit=2,file='/data/mta/Script/Ephem/Exc/dephem.gsme')
c      open(unit=3,file='/data/mta/Script/Ephem/PE.EPH.gsme_in_Re')
