...
C     Open input file containing magnetosphere data.
      IF(ISPECI.EQ.1) THEN
c       OPEN(LUNIT,FILE='/data/mta4/proj/rac/ops/CRM/v1.21/crmflx_v1.2_2&
c    &5jan2001/MSPH_Kp_PROT.BIN',
c    &5jan2001/MSPH_Kp_PROTDASC',

        OPEN(LUNIT,FILE='/data/mta4/Space_Weather/CRMFLX/CRMFLX_ver12_200
     &1/MSPH_Kp_PROT.BIN',
...
C     Open input file containing magnetosheath data.
      IF(ISPECI.EQ.1) THEN
c       OPEN(LUNIT,FILE='/data/mta4/proj/rac/ops/CRM/v1.21/crmflx_v1.2_2&
c    &5jan2001/MSheath_Kp_PROT.BIN',
c    &5jan2001/MSheath_Kp_PROT.ASC',

        OPEN(LUNIT,FILE='/data/mta4/Space_Weather/CRMFLX/CRMFLX_ver12_200
     &1/MSheath_Kp_PROT.BIN',
...
C     Open input file containing solar wind data.
      IF(ISPECI.EQ.1) THEN
c       OPEN(LUNIT,FILE='/data/mta4/proj/rac/ops/CRM/v1.21/crmflx_v1.2_2&
c    &5jan2001/SolWind_Kp_PROT.BIN',
c    &5jan2001/SolWind_Kp_PROT.ASC',

        OPEN(LUNIT,FILE='/data/mta4/Space_Weather/CRMFLX/CRMFLX_ver12_200
     &1/SolWind_Kp_PROT.BIN',
