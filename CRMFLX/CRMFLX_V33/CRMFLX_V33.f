...
C     Open input file containing magnetosphere data.
      IF(ISPECI.EQ.1) THEN
        OPEN(LUNIT,FILE=
     $  '/data/mta4/Space_Weather/CRMFLX/CRMFLX_V33/MSPH_Kp_PROT.BIN',
...
C     Open input file containing magnetosheath data.
      IF(ISPECI.EQ.1) THEN
        OPEN(LUNIT,FILE=
     $  '/data/mta4/Space_Weather/CRMFLX/CRMFLX_V33/MSheath_Kp_PROT.BIN',
     $    ACCESS='SEQUENTIAL',FORM='UNFORMATTED',STATUS='OLD')
      ELSE IF(ISPECI.EQ.2) THEN
...
C     Open input file containing solar wind data.
      IF(ISPECI.EQ.1) THEN
        OPEN(LUNIT,FILE=
     $  '/data/mta4/Space_Weather/CRMFLX/CRMFLX_V33/SolWind_Kp_PROT.BIN',
     $    ACCESS='SEQUENTIAL',FORM='UNFORMATTED',STATUS='OLD')
      ELSE IF(ISPECI.EQ.2) THEN
