...
C   to supple sburoutines/functions needed in cocochan.f and geopack.f
C
C
...
C
CD     WRITE(*,*)
CD     WRITE(*,*)' ENTER BOWSHK2!'
CD     WRITE(*,*)' BX,BY,BZ,VX,VY,VZ = ',BX,BY,BZ,VX,VY,VZ
CD     WRITE(*,*)' DENNUM,SWETEMP,SWPTEMP = ',DENNUM,SWETEMP,SWPTEMP
CD     WRITE(*,*)' HEFRAC,SWHTEMP,XPOS = ',HEFRAC,SWHTEMP,XPOS
CD     WRITE(*,*)' ETEMP,PTEMP,HETEMP = ',ETEMP,PTEMP,HETEMP
CD     PAUSE  'PAUSED!!'
CD     WRITE(*,*)
C
...
C
      ...
      BOWRAD = RHOX
CD     WRITE(*,*)' XPOS,BOWANG,BOWRAD = ',XPOS,BOWANG,BOWRAD
C
 2000 CONTINUE 
C
      RETURN 
...
C
CD     WRITE(*,*)
CD     WRITE(*,*)' Entered LOCREG!'
CD     WRITE(*,*)' XKP,XGSM,YGSM,ZGSM = ',
CD    $            XKP,XGSM,YGSM,ZGSM
CD     PAUSE
C
...
C
CD     WRITE(*,*)
CD     WRITE(*,*)' ENTERED ROT8ANG!'
CD     WRITE(*,*)' ANG,X,Y,XHINGE = ',ANG,X,Y,XHINGE
CD     PAUSE
C
C
      IF(X.LE.XHINGE) THEN
      ...
      ELSE
        ...
        YROT2 = Y
      END IF
CD     WRITE(*,*)' ANG,XROT2,YROT2 = ',ANG,XROT2,YROT2
CD     PAUSE
      RETURN
      END
C
