...
web_dir = html_dir     + 'Orbit/'
dfile   = gsm_plot_dir + 'Data/gs_data_2_day'
...
zee =  1
read_gif,gsm_plot_dir+'Scripts/Template/FluxImageColorKey.gif', key, r, g, b
...
IF (zee eq  1) THEN BEGIN 
    ...
    ;WRITE_GIF, web_dir+'GSEORBIT'+version+'.gif', out, R, G, B
    WRITE_GIF, web_dir+'Plots/GSEORBIT.gif', out, R, G, B
ENDIF 
...
IF (zee eq  1) THEN BEGIN 
    out = tvrd()
    WRITE_GIF, web_dir+'Plots/GSMORBIT.gif', out, R, G, B
ENDIF 


;+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
;++ THE FOLLOWING SECTION IS NOT USED ANYMORE.                                                     +++
;+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

;openw, 2, web_dir+'orbit.html'
;printf, 2, '<!DOCTYPE html>'
;printf, 2, '<html>'
;printf, 2, '<head>'
;printf, 2, '<title>Chandra Orbit </title>'
;printf, 2, '</head>'
;printf, 2, '<body style="width:95%;margin-left:10px; margin-right;10px;background-color:#FAEBD7;font-family:Georgia, "Times New Roman", Times, serif">'

;printf, 2, '<div style='text-align:center;'>'
;printf, 2, '<h2>The Current Orbital Profile</h2>'
;printf, 2, '<h4>All dates 00 hours UT</h4>'
;printf, 2, '</div>'

;printf, 2, '<hr />'
;printf, 2, <a href="http://www.spenvis.oma.be/spenvis/help/background/coortran/coortran.html">SPENVIS </a> The coordinate systems and transformations used here.<br>'
