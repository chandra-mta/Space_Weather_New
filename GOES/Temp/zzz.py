...
#
    ...
    for k in range(0, d_len):
        line = line + '\t' +  t_list[k]  + '\t\t'
        line = line + "%1.5f\t" % (p_data[0][1][k])
        line = line + "%1.5f\t" % (p_data[1][1][k])
        line = line + "%1.5f\t" % (p_data[2][1][k])
        line = line + "%1.5f\t" % (p_data[3][1][k])
        line = line + "%1.5f\t" % (p_data[4][1][k])
        line = line + "%1.5f\t" % (p_data[5][1][k])
        line = line + "%1.5f\t" % (p_data[6][1][k])
        line = line + "%1.5f\t" % (p_data[7][1][k])
        line = line + "%1.5f\t" % (p_data[8][1][k])
        line = line + "%1.5f\t" % (p_data[9][1][k])
        line = line + "%1.5f\t" % (p_data[10][1][k])
        line = line + "%1.5f\t" % (p_data[11][1][k])
        line = line + "%1.5f\t" % (p_data[12][1][k])
        line = line + "%5.0f\t\n" % (hrc_val[k])
